...
def accueil(screen,bg,buttons,mouse,x,y,play,game_launch,exit,main_font,dialogue,options):
...
def print_text(screen,main_font,x,y,text,dialogue):
    ...
    dialogue = pygame.transform.scale(dialogue,(font_size[0]+15,font_size[1]+20))
